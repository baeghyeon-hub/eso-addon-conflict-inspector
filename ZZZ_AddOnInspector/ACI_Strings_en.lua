...
S.SV_TAG_WASTE          = " |cFF0000[waste]|r"
...
S.FMT_SAFE_DELETE_SAVES    = " — saves %.1f KB"
S.FMT_SAFE_DELETE_HEADER   = "[ACI] |cFF6600● Safe to delete (%d)|r — unused AND outdated:%s"
S.FMT_SAFE_DELETE_ENTRY    = "[ACI]   %s%s"
S.FMT_SAFE_DELETE_SIZE_MB  = " |c888888(%.2f MB)|r"
S.FMT_SAFE_DELETE_SIZE_KB  = " |c888888(%.1f KB)|r"
S.SAFE_DELETE_NOTE         = "[ACI]   |cCCCCCC^ No dependents, no updates. Zero-risk removal.|r"
