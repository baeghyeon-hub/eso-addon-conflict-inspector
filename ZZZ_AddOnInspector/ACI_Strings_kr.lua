...
S.FMT_SAFE_DELETE_SAVES    = " — %.1f KB 절약"
S.FMT_SAFE_DELETE_HEADER   = "[ACI] |cFF6600● 삭제 가능 (%d)|r — 미사용 + 구버전:%s"
S.FMT_SAFE_DELETE_ENTRY    = "[ACI]   %s%s"
S.FMT_SAFE_DELETE_SIZE_MB  = " |c888888(%.2f MB)|r"
S.FMT_SAFE_DELETE_SIZE_KB  = " |c888888(%.1f KB)|r"
S.SAFE_DELETE_NOTE         = "[ACI]   |cCCCCCC^ 의존 없음, 업데이트 없음. 무위험 제거.|r"
